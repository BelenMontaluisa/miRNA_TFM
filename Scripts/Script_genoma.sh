...
# Se obtiene el filtrado de archivos con grep
## -E permite usar expresiones regulares extendidas (para buscar patrones más complejos) y -o extrae sólo la parte del texto que coincide con el patrón. 
## 'href="[^"]+\.gz"' 
