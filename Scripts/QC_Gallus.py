...
"""
# =============================================================================
#  Revisión de calidad de las secuencias
# =============================================================================
...
seqs = [str(rec.seq) for rec in SeqIO.parse("hairpin_high_conf_gga_1.fasta", "fasta")]
...
plt.title("Distribución de longitudes de pre-miRNA en Gallus gallus")
plt.show()
...
# =============================================================================
# Archivo de entrada
rna_inicial = "hairpin_high_conf_gga_1.fasta"

# Archivo de salida
rna_final = "hairpin_gga_filtrado.fasta"
filtered_records = []
removed_records = []
