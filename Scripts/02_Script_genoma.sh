#!/bin/bash
# ==========================================================
# Descarga de cromosomas de Diglossa brunneiventris
# ==========================================================
...
## while read -r file permite leer el archivo lista_archivos_cromosomas.txt línea por línea y guarda la linea en la variable file. 
